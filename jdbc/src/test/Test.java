...
//		회원 전체 수만큼 반복돌리며 회원정보 조회
//		UserDAO userDAO = new UserDAO();
//		ArrayList<UserVO> users = new ArrayList<UserVO>();
//		
//		
//		  for (int i = 0; i < userDAO.getTotalUserCount(); i++) {
//		  users.add(userDAO.selectUser(i+1)); }
//		 
////		  for (UserVO userInfo : users) { System.out.println(userInfo); }
//		 
//		
//		users.stream().forEach(System.out::println);
		
//		UserDAO userDAO = new UserDAO();
//		System.out.println(userDAO.selectUser(0));
